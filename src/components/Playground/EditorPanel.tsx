...
function registerAmpscript(monaco: any) {
  ...
  monaco.languages.registerCompletionItemProvider(LANG, {
    provideCompletionItems(model: any, position: any) {
      ...
      const functions = [
        'CHAR', 'CONCAT', 'DOMAIN', 'FORMAT', 'FORMATCURRENCY', 'FORMATNUMBER',
        'INDEXOF', 'LENGTH', 'LOWERCASE', 'PROPERCASE',
        'REGEXMATCH', 'REPLACE', 'REPLACELIST',
        'STRINGTOHEX', 'SUBSTRING', 'TRIM', 'UPPERCASE', 'URLENCODE',
        'ADD', 'DIVIDE', 'MOD', 'MULTIPLY', 'RANDOM', 'SUBTRACT',
        'DATEADD', 'DATEDIFF', 'DATEPARSE', 'DATEPART', 'FORMATDATE',
        'GETSENDTIME', 'LOCALDATETOSYSTEMDATE', 'NOW',
        'STRINGTODATE', 'SYSTEMDATETOLOCALDATE',
        'ATTRIBUTEVALUE', 'EMPTY', 'GUID', 'IIF',
        'ISEMAILADDRESS', 'ISNULL', 'ISNULLDEFAULT', 'ISPHONENUMBER',
        'OUTPUT', 'OUTPUTLINE', 'RAISEERROR', 'TREATASCONTENT', 'V',
        ...
        'DATAEXTENSIONROWCOUNT', 'DELETEDATA', 'DELETEDE',
        'FIELD', 'INSERTDATA', 'INSERTDE',
